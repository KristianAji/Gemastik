...
const REGULASI = [
  {
    ...
    icon: '🇮🇩',
    kode: 'UUD 1945',
    judul: 'Undang-Undang Dasar Negara Republik Indonesia',
    tahun: '1945',
    kategori: 'Konstitusi',
    warna: '#E8401C',
    ringkasan: 'Landasan konstitusional perlindungan anak di Indonesia.',
    pasal: [
      { nomor: 'Pasal 28B Ayat (2)', isi: 'Setiap anak berhak atas kelangsungan hidup, tumbuh, dan berkembang serta berhak atas perlindungan dari kekerasan dan diskriminasi.' },
      { nomor: 'Pasal 34 Ayat (1)', isi: 'Fakir miskin dan anak-anak terlantar dipelihara oleh negara.' },
    ],
  },
  {
    id: 'uu35',
    icon: '⚖️',
    kode: 'UU No. 35/2014',
    judul: 'Perubahan atas UU No. 23/2002 tentang Perlindungan Anak',
    tahun: '2014',
    kategori: 'Undang-Undang',
    warna: '#F5A623',
    ringkasan: 'Regulasi utama perlindungan anak dari segala bentuk kekerasan, eksploitasi, dan penelantaran.',
    pasal: [
      { nomor: 'Pasal 13 Ayat (1)', isi: 'Setiap anak selama dalam pengasuhan orang tua, wali, atau pihak lain mana pun yang bertanggung jawab atas pengasuhan, berhak mendapat perlindungan dari perlakuan diskriminasi, eksploitasi ekonomi maupun seksual.' },
      { nomor: 'Pasal 59 Ayat (2)', isi: 'Perlindungan khusus diberikan kepada anak yang bekerja dan/atau dieksploitasi secara ekonomi.' },
      { nomor: 'Pasal 76I', isi: 'Setiap orang dilarang menempatkan, membiarkan, melakukan, menyuruh melakukan, atau turut serta melakukan eksploitasi secara ekonomi dan/atau seksual terhadap anak.' },
    ],
  },
  {
    id: 'uu13',
    ...
    kategori: 'Undang-Undang',
    warna: '#3B8FE8',
    ringkasan: 'Mengatur batasan usia kerja dan larangan mempekerjakan anak di bawah umur.',
    pasal: [
      { nomor: 'Pasal 68', isi: 'Pengusaha dilarang mempekerjakan anak. Yang dimaksud anak adalah setiap orang yang berumur di bawah 18 tahun.' },
      { nomor: 'Pasal 69 Ayat (1)', isi: 'Ketentuan sebagaimana dimaksud dalam Pasal 68 dapat dikecualikan bagi anak yang berumur antara 13 tahun sampai dengan 15 tahun untuk melakukan pekerjaan ringan sepanjang tidak mengganggu perkembangan dan kesehatan fisik, mental, dan sosial.' },
      { nomor: 'Pasal 74 Ayat (1)', isi: 'Siapapun dilarang mempekerjakan dan melibatkan anak pada pekerjaan-pekerjaan yang terburuk.' },
    ],
  },
  {
    id: 'kha',
    icon: '🌍',
    kode: 'Konvensi Hak Anak PBB',
    judul: 'Convention on the Rights of the Child (CRC) — Diratifikasi via Keppres No. 36/1990',
    tahun: '1989',
    kategori: 'Internasional',
    warna: '#2ECC71',
    ringkasan: 'Perjanjian internasional yang mengakui hak-hak sipil, politik, ekonomi, sosial, dan budaya anak.',
    pasal: [
      { nomor: 'Pasal 32', isi: 'Negara mengakui hak anak untuk dilindungi dari eksploitasi ekonomi dan dari melakukan pekerjaan apa pun yang kemungkinan berbahaya atau mengganggu pendidikan anak, atau berbahaya bagi kesehatan atau perkembangan fisik, mental, spiritual, moral, atau sosial anak.' },
      { nomor: 'Pasal 28', isi: 'Negara mengakui hak anak atas pendidikan, dan mewujudkan hak ini secara progresif dan atas dasar kesempatan yang sama, khususnya dengan mewajibkan dan menyediakan pendidikan dasar gratis untuk semua.' },
      { nomor: 'Pasal 19', isi: 'Negara mengambil semua tindakan legislatif, administratif, sosial, dan pendidikan yang tepat untuk melindungi anak dari segala bentuk kekerasan fisik atau mental, cedera atau penyalahgunaan, penelantaran atau perlakuan lalai, penganiayaan atau eksploitasi.' },
    ],
  },
  {
    id: 'ilo',
    icon: '🤝',
    kode: 'Konvensi ILO No. 182',
    judul: 'Penghapusan Bentuk-Bentuk Pekerjaan Terburuk untuk Anak',
    tahun: '1999',
    kategori: 'Internasional',
    warna: '#9B59B6',
    ringkasan: 'Konvensi ILO yang diratifikasi Indonesia melalui UU No. 1/2000, melarang bentuk pekerjaan terburuk anak.',
    pasal: [
      { nomor: 'Pasal 1', isi: 'Setiap Anggota yang meratifikasi Konvensi ini harus mengambil tindakan segera dan efektif untuk menjamin pelarangan dan penghapusan bentuk-bentuk pekerjaan terburuk untuk anak sebagai hal yang mendesak.' },
      { nomor: 'Pasal 3', isi: 'Bentuk-bentuk pekerjaan terburuk untuk anak meliputi segala bentuk perbudakan atau praktik serupa perbudakan, perekrutan paksa, penggunaan, penawaran atau pemberian anak untuk kegiatan yang tidak sah.' },
    ],
  },
  {
    id: 'perpres',
    icon: '📜',
    kode: 'Perpres No. 75/2015',
    judul: 'Rencana Aksi Nasional Penghapusan Pekerja Anak',
    tahun: '2015',
    kategori: 'Peraturan Presiden',
    warna: '#E67E22',
    ringkasan: 'Rencana aksi pemerintah untuk menghapus pekerja anak secara bertahap dan menyeluruh.',
    pasal: [
      { nomor: 'Lampiran Bab II', isi: 'Penghapusan pekerja anak dilakukan melalui pendekatan pencegahan, penarikan, rehabilitasi, dan reintegrasi anak ke dalam keluarga dan masyarakat.' },
      { nomor: 'Lampiran Bab III', isi: 'Pemerintah daerah berkewajiban menyusun rencana aksi daerah dan mengalokasikan anggaran yang memadai untuk program perlindungan anak dari eksploitasi ekonomi.' },
    ],
  },
]
